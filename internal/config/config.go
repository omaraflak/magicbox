...
func Load() (*Config, error) {
	...
	paths := keymanager.NewKeyPaths(root)
...
// RecoverKeys derives keys from a mnemonic and writes them to disk.
// This is a convenience wrapper around keymanager.RecoverAll.
